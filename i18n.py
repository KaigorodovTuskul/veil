...
MESSAGES = {
    "ru": {
        ...
        "user_dictionary": "Пользовательский словарь: {keywords} записей; исключений: {ignored}",
    ...
    "en": {
        ...
        "user_dictionary": "User dictionary: {keywords} entries; ignored phrases: {ignored}",
    ...
    "zh": {
        ...
        "user_dictionary": "用户词典：{keywords} 条；忽略短语：{ignored}",
