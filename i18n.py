...
MESSAGES = {
    "ru": {
        ...
        "filename_hidden": "Имя исходного файла скрыто; безопасное имя: {value}",
    ...
    "en": {
        ...
        "filename_hidden": "The source filename is hidden; safe name: {value}",
    ...
    "zh": {
        ...
        "filename_hidden": "源文件名已隐藏；安全文件名：{value}",
        "restored": "已恢复：{value}",
